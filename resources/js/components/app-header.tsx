      ...
      <div className="border-b border-sidebar-border/80">
        <div className="mx-auto flex h-16 items-center px-4 md:max-w-7xl">
          ...
          <div className="lg:hidden">
            <Sheet>
              <SheetTrigger
                render={<Button variant="ghost" size="icon" className="mr-2 h-[34px] w-[34px]" />}
              >
          ...
          <Link href={dashboard()} prefetch="mount" className="flex items-center space-x-2">
            <AppLogo />
          </Link>
              ...
              <DropdownMenu>
                ...
                >
                  <Avatar className="size-8 overflow-hidden rounded-full">
                    <AvatarImage src={auth.user.photo_url ?? undefined} alt={auth.user.name} />
